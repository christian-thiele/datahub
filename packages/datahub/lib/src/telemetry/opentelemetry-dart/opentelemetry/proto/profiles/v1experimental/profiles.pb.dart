...
import 'pprofextended.pb.dart' as $8;
...
class ProfileContainer extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$8.Profile>(8, _omitFieldNames ? '' : 'profile',
        subBuilder: $8.Profile.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  $core.List<$4.KeyValue> get attributes => $_getList(3);
  ...
  @$pb.TagNumber(8)
  $8.Profile get profile => $_getN(7);
  @$pb.TagNumber(8)
  set profile($8.Profile v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(8)
  $8.Profile ensureProfile() => $_ensure(7);
}
