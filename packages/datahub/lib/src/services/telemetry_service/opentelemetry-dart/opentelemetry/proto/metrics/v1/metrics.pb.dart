...
class ResourceMetrics extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'opentelemetry.proto.metrics.v1'),
      createEmptyInstance: create)
    ..aOM<$5.Resource>(1, _omitFieldNames ? '' : 'resource',
        subBuilder: $5.Resource.create)
    ..pc<ScopeMetrics>(
...
class ScopeMetrics extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'opentelemetry.proto.metrics.v1'),
      createEmptyInstance: create)
    ..aOM<$4.InstrumentationScope>(1, _omitFieldNames ? '' : 'scope',
        subBuilder: $4.InstrumentationScope.create)
  ...
  @$pb.TagNumber(1)
  set scope($4.InstrumentationScope v) {
    setField(1, v);
  }
...
class Metric extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$4.KeyValue>(12, _omitFieldNames ? '' : 'metadata', $pb.PbFieldType.PM,
  ...
  @$pb.TagNumber(12)
  $core.List<$4.KeyValue> get metadata => $_getList(8);
}
...
class NumberDataPoint extends $pb.GeneratedMessage {
  ...
  /// attribute with the same key).
  @$pb.TagNumber(7)
  $core.List<$4.KeyValue> get attributes => $_getList(5);
...
class HistogramDataPoint extends $pb.GeneratedMessage {
  ...
  /// attribute with the same key).
  @$pb.TagNumber(9)
  $core.List<$4.KeyValue> get attributes => $_getList(7);
...
class ExponentialHistogramDataPoint extends $pb.GeneratedMessage {
  ...
  /// attribute with the same key).
  @$pb.TagNumber(1)
  $core.List<$4.KeyValue> get attributes => $_getList(0);
...
class Exemplar extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(7)
  $core.List<$4.KeyValue> get filteredAttributes => $_getList(5);
}
