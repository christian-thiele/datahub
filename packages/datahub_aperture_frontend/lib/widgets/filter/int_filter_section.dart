...
class IntFilterSection extends StatefulWidget {
  final String name;
  final void Function(ResourceFilterType, int value) onSubmit;

  const IntFilterSection({
    super.key,
    required this.name,
  ...
  @override
  State<IntFilterSection> createState() => _IntFilterSectionState();
}

class _IntFilterSectionState extends State<IntFilterSection> {
